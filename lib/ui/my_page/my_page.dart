            ...
            child: IntrinsicHeight(
              child: Row(
                ...
                children: [
                  Column(
                    children: [
                      _createGradeImage(GradeExtension.getImage(_user.grade)),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
            ...
            child: Stack(
              children: [
                TweenAnimationBuilder(
                  tween: Tween<double>(begin: 0.0, end: _user.getProgress()),
            ...
            child: Row(
              children: [
                Expanded(
                  ...
                  showCashChargingDialog(context, _user.cash, (value) {
                ...
                Expanded(
                    child: _createInfoCard(
                        'My 쿠폰', _user.getCouponProgress(), '상세보기', () {
                  showCouponListDialog(context, _user.list, (value) {
              ...
              child: Column(
                children: [
                  ...
                  _createMyPageMenu('회원 탈퇴', () {
                    showWithdrawalDialog(context, () => _doWithdrawal());
                  }),
                ],
              ),
            ),
